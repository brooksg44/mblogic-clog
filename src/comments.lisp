...
;; *il-file* must be set via --eval before loading this script or this code
(defvar *il-file*
...
(defparameter *parsed-prog*
  (mblogic-clog:parse-il-file *il-file*))
...
(let ((main-nets (mblogic-clog:program-main-networks *parsed-prog*)))
  (when main-nets
    (format t "    - main~%")))
